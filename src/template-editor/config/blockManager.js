const bootstrapBasicBlocks = [
  ...
  },
  {
    ...
    content: `<div class="product-card" id="product__card__block">
    <img
      class="product-img"
      src="https://demo-egenslab.b-cdn.net/html/foxture/assets/images/shop/shope-two-prodict-img-1.png"
    />
    <a class="wishlist-icon"> <i class="fa fa-heart"></i></a>
    ...
    <div class="product-details">
      <div class="product-review">
        ...
        <i class="fa fa-star"></i>
        <i class="fa fa-star"></i>
        <span class="product-total-review">( 32 reviews )</span>
      </div>
      <div class="product-name">Apple</div>
      <div class="product-price">
        <span>$ 100</span>
        <span class="product-mob-icon">
  ...
  },
  {
    ...
    content: `<div class="section" data-gjs-droppable=".cell" data-gjs-custom-name="Row">
  <div class="block block-1" data-gjs-draggable=".section" data-gjs-custom-name="block"></div>
  </div><style> .section{display: flex; flex-wrap:wrap; padding: 30px 15%;} .block{ flex: 50%; 
  ...
  },
  {
    ...
    content: `<div class="section" data-gjs-droppable=".cell" data-gjs-custom-name="Row">
    <div class="block block-2" data-gjs-draggable=".section" data-gjs-custom-name="block"></div>
    <div class="block block-2" data-gjs-draggable=".section" data-gjs-custom-name="block"></div>
    </div><style> .section{display: flex; flex-wrap:wrap; padding: 30px 15%;} .block{ flex: 50%;
      display:flex;justify-content:center; align-items:center;
      padding: 2% 0;} @media screen and (max-width: 451px){.block{flex:100%;}} </style>`,
  },
  {
    id: "b3",
    label: "3 Blocks",
    ...
    <div class="block block-2" data-gjs-draggable=".section" data-gjs-custom-name="block"></div>
    <div class="block block-2" data-gjs-draggable=".section" data-gjs-custom-name="block"></div>
    </div><style> .section{display: flex; flex-wrap:wrap; padding: 30px 15%;} .block{ flex: 32%;
      display:flex;justify-content:center; align-items:center;
      padding: 2% 0;} @media screen and (max-width: 451px){.block{flex:100%;}} @media screen and (max-width: 768px){.block{flex:50%;}} </style>`,
  },
  {
    id: "b4",
    label: "4 Blocks",
    ...
    <div class="block block-2" data-gjs-draggable=".section" data-gjs-custom-name="block"></div>
    <div class="block block-2" data-gjs-draggable=".section" data-gjs-custom-name="block"></div>
    </div><style> .section{display: flex; flex-wrap:wrap; padding: 30px 15%;} .block{ flex: 25%;
      display:flex;justify-content:center; align-items:center;
      padding: 2% 0;} @media screen and (max-width: 451px){.block{flex:100%;}} @media screen and (max-width: 768px){.block{flex:50%;}} </style>`,
  },
  {
    ...
    content: `<section id="hero" class="d-flex flex-column align-items-center justify-content-center pt-4">
        <h2 class="hero-title display-2 text-uppercase mt-5"><span class="text-primary">P</span>ranaforce</h2>
        <p class="hero-subtitle display-6">Fastest way to scale your business !</p>
  ...
  },
  {
    ...
    content: `<section id="blog">
          <div class="section-header container">
            <h3 class="display-6 p-4 text-uppercase">Featured Products</h3>
          </div>
          <div class="container">
            <div class="row">
              <div class="col-lg-4 col-md-6 mb-2">
                <div class="post bg-white shadow-sm rounded">
                  <div class="post-image" style="height:200px;display:flex;justify-content:center">
                    <img src="https://www.linkpicture.com/q/chair2.png" alt="" style="height:100%;object-fit:cover;">
                  </div>
              ...
              <div class="col-lg-4 col-md-6 mb-2">
                <div class="post bg-white shadow-sm rounded">
                  <div class="post-image" style="height:200px;display:flex;justify-content:center">
                    <img src="https://www.linkpicture.com/q/chair1.png" alt="" style="height:100%;object-fit:cover;">
                  </div>
                  <div class="post-content p-4">
                    <a href="#" class="text-decoration-none text-dark text-uppercase">
                      <h3>Product name</h3>
  ...
  },
  {
    ...
    content: `<section id="contact" class="bg-white">
     ...
     <div class="invalid-feedback">Name is required</div>
                ...
                <div class="form-group my-3">
                  <label htmlFor="phone">Phone <small class="text-muted">- optional</small></label>
